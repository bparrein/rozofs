...
#define EP_LOOKUP 4
    ...
    extern ep_mattr_ret_t *ep_lookup_1_svc(ep_lookup_arg_t *,
                                           struct svc_req *);
#define EP_GETATTR 5
    extern ep_mattr_ret_t *ep_getattr_1(ep_mfile_arg_t *, CLIENT *);
    extern ep_mattr_ret_t *ep_getattr_1_svc(ep_mfile_arg_t *,
                                            struct svc_req *);
#define EP_SETATTR 6
    extern ep_mattr_ret_t *ep_setattr_1(ep_setattr_arg_t *, CLIENT *);
    extern ep_mattr_ret_t *ep_setattr_1_svc(ep_setattr_arg_t *,
                                            struct svc_req *);
#define EP_READLINK 7
    extern ep_readlink_ret_t *ep_readlink_1(ep_mfile_arg_t *, CLIENT *);
    extern ep_readlink_ret_t *ep_readlink_1_svc(ep_mfile_arg_t *,
                                                struct svc_req *);
#define EP_MKNOD 8
...
#define EP_UNLINK 10
    ...
    extern ep_status_ret_t *ep_unlink_1_svc(ep_mfile_arg_t *,
                                            struct svc_req *);
#define EP_RMDIR 11
    extern ep_status_ret_t *ep_rmdir_1(ep_mfile_arg_t *, CLIENT *);
    extern ep_status_ret_t *ep_rmdir_1_svc(ep_mfile_arg_t *,
                                           struct svc_req *);
#define EP_SYMLINK 12
    extern ep_mattr_ret_t *ep_symlink_1(ep_symlink_arg_t *, CLIENT *);
    extern ep_mattr_ret_t *ep_symlink_1_svc(ep_symlink_arg_t *,
                                            struct svc_req *);
#define EP_RENAME 13
    extern ep_status_ret_t *ep_rename_1(ep_rename_arg_t *, CLIENT *);
    extern ep_status_ret_t *ep_rename_1_svc(ep_rename_arg_t *,
                                            struct svc_req *);
#define EP_READDIR 14
    extern ep_readdir_ret_t *ep_readdir_1(ep_mfile_arg_t *, CLIENT *);
    extern ep_readdir_ret_t *ep_readdir_1_svc(ep_mfile_arg_t *,
                                              struct svc_req *);
#define EP_READ 15
...
#define EP_READ_BLOCK 16
    extern ep_read_block_ret_t *ep_read_block_1(ep_read_block_arg_t *,
                                                CLIENT *);
    extern ep_read_block_ret_t *ep_read_block_1_svc(ep_read_block_arg_t *,
                                                    struct svc_req *);
#define EP_WRITE 17
...
#define EP_WRITE_BLOCK 18
    extern ep_status_ret_t *ep_write_block_1(ep_write_block_arg_t *,
                                             CLIENT *);
    extern ep_status_ret_t *ep_write_block_1_svc(ep_write_block_arg_t *,
                                                 struct svc_req *);
#define EP_OPEN 19
...
#define EP_CLOSE 20
    ...
    extern ep_status_ret_t *ep_close_1_svc(ep_mfile_arg_t *,
                                           struct svc_req *);
