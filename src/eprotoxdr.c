...
xdr_ep_uuid_t (XDR *xdrs, ep_uuid_t objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_vector (xdrs, (char *)objp, ROZO_UUID_SIZE,
...
xdr_ep_link_t (XDR *xdrs, ep_link_t objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_vector (xdrs, (char *)objp, ROZO_PATH_MAX,
...
xdr_ep_cluster_t (XDR *xdrs, ep_cluster_t *objp)
{
	...
	int i;
	 ...
	 if (!xdr_uint8_t (xdrs, &objp->storages_nb))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->storages, ROZO_STORAGES_MAX,
...
xdr_ep_volume_t (XDR *xdrs, ep_volume_t *objp)
{
	...
	int i;
	 ...
	 if (!xdr_uint8_t (xdrs, &objp->clusters_nb))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->clusters, ROZO_CLUSTERS_MAX,
...
xdr_ep_mattr_t (XDR *xdrs, ep_mattr_t *objp)
{
	...
	int i;
	 ...
	 if (!xdr_uint16_t (xdrs, &objp->cid))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->sids, ROZO_SAFE_MAX,
